...
<img
    ...
    />
      ...
      <ul className="space-y-2">
        ...
        <li>
          <Link to="/product" className="hover:text-gray-700 transition">Products</Link>
        </li>
        <li>
          <Link to="/insight" className="hover:text-gray-700 transition">Insight</Link>
        </li>
        <li>
          <Link to="/faqs" className="hover:text-gray-700 transition">FAQs</Link>
        </li>
      </ul>
    </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li>Phone: <a href="tel:+254720907612" className="hover:text-gray-700 transition">+254 720 907 612</a></li>
            <li>Email: <a href="mailto:info@ignis-innovation.com" className="hover:text-gray-700 transition">info@ignis-innovation.com</a></li>
          </ul>
        </div>
      </div>

      <div className="mt-12 border-t border-black pt-4 text-center text-black text-sm">
